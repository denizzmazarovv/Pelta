    ...
    >
      <nav className="max-w-7xl mx-auto px-5 sm:px-8 flex items-center justify-between">
        <a href="#home" className="flex items-center gap-2 group">
          <img src={scrolled ? "/cream-background-ellipse.svg" : "/apple-touch-icon.png"} alt="Pelta Nera Logo" className={`w-10 h-10 transition-transform rounded-full ${scrolled ? 'scale-90 rotate-[90deg]' : 'scale-100 rotate-0'}`} />
